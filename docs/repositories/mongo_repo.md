...
!!! info
    Класс предназначен для работы с коллекцией MongoDB и валидации данных через Pydantic-модель. Все методы возвращают данные в формате словарей, соответствующих Pydantic-модели.
